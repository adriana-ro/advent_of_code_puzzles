...
#====================#
  ...
  # load the file 
  puzzle_11 <- fread("/projects/general/rodriguez/advent_of_code/2020/puzzle_input1_day_11.txt", header = F, fill = T)
...
#=================#
  ...
  # 
  puzzle_11 <- data.table(V1 = c("L.LL.LL.LL",
                          "LLLLLLL.LL",
                          "L.L.L..L..",
                          "LLLL.LL.LL",
                          "L.LL.LL.LL",
...
input <- readLines("/projects/general/rodriguez/advent_of_code/2020/puzzle_input1_day_11.txt")
