...
for line in open('/projects/general/rodriguez/advent_of_code/2020/puzzle_input1_day_7.txt').readlines():
...
print(count_bags_inside('shiny gold')-1) # 45018
